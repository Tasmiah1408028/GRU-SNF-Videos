There are two folders: GRU-SNF and GRU-NF. Each folder includes diverse sample videos generated using GRU-SNF and GRU-NF, where multiple predicted outputs correspond to a single ground truth video.
